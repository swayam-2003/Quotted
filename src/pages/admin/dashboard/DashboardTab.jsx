...
function DashboardTab() {
    ...
    const goToSlogan = () => {
        window.location.href = '/addslogan'
    }

    const goToCouponAddPage = () => {
        window.location.href = '/addcouponcode'
    }
                                    ...
                                    <div onClick={goToCouponAddPage}>
                                        <button
                                            ...
                                            className="focus:outline-none text-white bg-pink-600 shadow-[inset_0_0_10px_rgba(0,0,0,0.6)] border hover:bg-pink-700 outline-0 font-medium rounded-lg text-sm px-5 py-2.5 mb-2" style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '', }} > <div className="flex gap-2 items-center">
                                                Add Coupon Code <FaCartPlus size={20} />
                                            </div></button>
                                    </div>
                                    {/*Slogans button */}
                                    <div onClick={goToSlogan}>
                                        <button
                                            type="button"
                                            className="focus:outline-none text-white bg-pink-600 shadow-[inset_0_0_10px_rgba(0,0,0,0.6)] border hover:bg-pink-700 outline-0 font-medium rounded-lg text-sm px-5 py-2.5 mb-2" style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '', }} > <div className="flex gap-2 items-center">
                                                Add Slogans <FaCartPlus size={20} />
                                            </div></button>
                                    </div>
                                    <div onClick={goToAdd}>
                                        <button
                                ...
                                <div className="relative overflow-x-auto ">
                                    <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400  ">
                                        ...
                                        {product.map((item, index) => {
                                            const { title, price, imageUrl1, category, date } = item;
                                            return (
                                                <tbody key={index}>
                                    ...
                                    <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400" key={index}>
                                        ...
                                        <tbody>
                                            {allOrder.cartItems.map((item, itemIndex) => {
                                                const { title, category, imageUrl1, price } = item;
                                                const addressInfo = allOrder.addressInfo || {};
                                                return (
                                                    <tr className="bg-gray-50 border-b dark:border-gray-700" style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '' }} key={itemIndex}>
                                                        <td className="px-6 py-4 text-black" style={{ color: mode === 'dark' ? 'white' : '' }}>
                                                            {itemIndex + 1}.
                                                        </td>
                                                        <td className="px-6 py-4 text-black" style={{ color: mode === 'dark' ? 'white' : '' }}>
