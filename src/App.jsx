...
import AddSlogan from './pages/admin/page/AddSlogan';
    ...
    <MyState>
      <Router>
        <Routes>
          ...
          <Route path="/addslogan" element={<ProtectedRouteForAdmin><AddSlogan /></ProtectedRouteForAdmin>} />
          <Route path="/addcouponcode" element={<ProtectedRouteForAdmin><AddCoupon /></ProtectedRouteForAdmin>} />
...
const ProtectedRouteForAdmin = ({ children }) => {
  ...
  if (admin.user.email === 'quoteadmin@gmail.com') {
    return children
  } else {
